-- Pipeline System Seed Data - Complete Reset & Reload
-- Usage: docker exec pipeline-db psql -U postgres -d pipeline_gis < /tmp/seed_fresh.sql
...
-- STEP 2: Insert Pipeline Systems
...
(1, 'Permian Main Trunk', ST_GeomFromText('LINESTRING(-102.0779 29.7604, -99.2433 31.2091, -95.3698 30.2672)', 4326), 0, 350, 30, 'Steel', 350),
(1, 'West Texas Branch', ST_GeomFromText('LINESTRING(-102.0779 29.7604, -101.8821 29.5764)', 4326), 0, 55, 24, 'Steel', 55),
(1, 'New Mexico Extension', ST_GeomFromText('LINESTRING(-102.0779 29.7604, -103.2258 28.8066)', 4326), 0, 85, 20, 'Steel', 85),

-- GasFlow Interstate routes
(2, 'OK-KS Gas Corridor', ST_GeomFromText('LINESTRING(-99.3033 35.4676, -97.5164 37.0842)', 4326), 0, 120, 36, 'Steel', 120),
(2, 'Panhandle Primary', ST_GeomFromText('LINESTRING(-101.5 35.5, -100.2 36.1)', 4326), 0, 95, 30, 'Steel', 95),

-- Eagle Ford routes
(3, 'Eagle Ford to Gulf', ST_GeomFromText('LINESTRING(-97.9 27.8, -94.5 29.3)', 4326), 0, 110, 16, 'Steel', 110),
...
-- STEP 8: Verify Data
SELECT '========== DATA UPLOAD SUMMARY ==========' as info;
